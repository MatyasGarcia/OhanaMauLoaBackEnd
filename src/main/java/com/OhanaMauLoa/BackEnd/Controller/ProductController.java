...
public class ProductController {
  ...
  @GetMapping("/products")
  public List<Product> getAllProducts(@RequestParam(required = false, defaultValue = "") String name,@RequestParam(required = false, defaultValue = "") String category, @RequestParam(required = false, defaultValue = "") String priceOrder){
    return this.productService.findAllProducts(name, category, priceOrder);
  }
}
